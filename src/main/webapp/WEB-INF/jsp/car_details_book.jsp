...
<body>
		...
		<div class="top">
			<div class="container clearfix">
				<ul class="clearfix fr">
					...
					<li><a href="" id="cancel">退出登录</a></li>
					<li><a href="" id="person">个人中心</a></li>
				</ul>
			</div>
		</div>
		<div class="header">
			<div class="container clearfix">
				<div class="logo fl">
					<a href=""><img src="${pageContext.request.contextPath}/resources/images/ZhkuParkingLogo.png"/></a>
				</div>
				<div class="mm fr clearfix">
					<a href="" id="checkcar">查车位</a>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="container clearfix">
			...
			<div class="main-left fl clearfix">
				...
				<div class="attr fl" style="width: 200px;">
					<p>车位编号：<span>车位三</span></p>
					<p>价格：<span>213.0</span></p>
					<p>路线推荐：进入停车场后直行5米，左转弯行驶<span>12</span>米</p>
					<a class="pay" id="book" href="">立即预约</a>
				</div>
	...
	<script src="http://api.map.baidu.com/api?v=2.0&amp;ak=QUSzk8g7c6Z10cAmLmfjgG1NB7aaBiyo&#10;" type="text/javascript"></script>
	<script type="text/javascript" src="http://api.map.baidu.com/getscript?v=2.0&amp;ak=QUSzk8g7c6Z10cAmLmfjgG1NB7aaBiyo&amp;services=&amp;t=20180629105709"></script>
