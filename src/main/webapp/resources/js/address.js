...
var dsy = new Dsy(); 
dsy.add("0",["安徽省","北京直辖市","福建省","甘肃省","广东省","广西壮族自治区","贵州省","海南省","河北省","河南省","黑龙江省","湖北省","湖南省","吉林省","江苏省","江西省","辽宁省","内蒙古自治区","宁夏回族自治区","青海省","山东省","山西省","陕西省","上海直辖市","四川省","天津直辖市","西藏自治区","新疆维吾尔自治区","云南","浙江省","重庆直辖市","香港特别行政区","澳门特别行政区","台湾省"]); 
...
dsy.add("0_4",["广州市","深圳市"])
//dsy.add("0_4",["广州","东莞","佛山","潮州","河源","惠州","江门","揭阳","茂名","梅州","清远","汕头","汕尾","韶关","深圳","阳江","云浮","湛江","肇庆","中山","珠海"]); 
dsy.add("0_4_0",["越秀区","海珠区","荔湾区","天河区","白云区","黄埔区","南沙区","番禺区","花都区","从化区","增城区"]); 
dsy.add("0_4_1",["福田区","罗湖区","南山区","盐田区","宝安区","龙岗区","龙华区","坪山区","光明区","大鹏新区"]);
//dsy.add("0_4_1",["东莞市"]); 
//dsy.add("0_4_2",["佛山市"]); 
//dsy.add("0_4_3",["潮安县","潮州市","饶平县"]);
